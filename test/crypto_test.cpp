...
//     std::string base58EncodedTestStr = "D61mfSggzbvQgTUe6JhYKH2doHaqJ3Dyib";

//     std::string encodedStrBuffer;
//     encodedStrBuffer.reserve(34);

//     Ark::Platform::Encoding::Base58::encode(&base58ToBeEncodedTestBytes[0], &encodedStrBuffer[0]);

//     bool encodedStringsMatch = encodedStrBuffer == base58EncodedTestStr;

//     assertEqual(base58EncodedTestStr, encodedStrBuffer);

//     // Serial.println("\n\n\n\n");
//     Serial.println(base58EncodedTestStr.c_str());
//     Serial.println(base58EncodedTestStr.size());
//     Serial.println(encodedStrBuffer.c_str());
//     Serial.println(encodedStrBuffer.size());
//     // Serial.println(encodedStringMatch);
//     // Serial.println("\n\n\n\n");
